...
export function Input() {
  ...
  const [name, setName] = useState ("") // Para armazenar o CNPJ da resposta
  ...
  async function buscarDados() {
    ...
    if (!data.cnpj && data.name && data.phoneIf && data.address) throw new Error("CNPJ, nome e telefone de contato não encontrados na resposta");
    ...
    <div>
      ...
      <div className="interface_de_dados">
        <ul>
          ...
          <li>
            <p><strong>Número: </strong>{adress.number || 'Numero não encontrado'}</p>
          </li>
          <li>
